...
| [DRIFT-005](issues/DRIFT-005.md) | Medium | Investigating | Concurrent workspace member changes can be overwritten | `drift.c:LoadMembersFrom`, `drift.c:SaveMembersTo`, membership edit callers | — | — | Confirmed; operation-level locked transaction recommended; awaiting user decision |
