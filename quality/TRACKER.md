...
| [DRIFT-006](issues/DRIFT-006.md) | Medium | Awaiting review | Relative `additionalDirectories` resolve against the wrong location | `drift.c:ResolveMemberPath`, `drift.c:FindMember`, `drift.c:JumpToMemberAt` | Codex | — | Anchor-aware identity implemented with spelling preservation and all-equivalent removal; awaiting independent review |
