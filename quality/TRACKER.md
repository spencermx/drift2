...
| [DRIFT-004](issues/DRIFT-004.md) | Medium | Awaiting review | Settings JSON scanner can edit the wrong object | `settings_json.h:DriftLocateSettingsJsonTarget`, `drift.c:LoadMembersFrom`, `drift.c:SaveMembersTo` | Codex | — | Implemented; awaiting independent review |
