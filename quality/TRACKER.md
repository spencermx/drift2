...
| [DRIFT-002](issues/DRIFT-002.md) | High | Investigating | Vim lookup can execute a planted `vim.exe` | `drift.c:393`, `drift.c:3157` | — | — | Confirmed; explicit absolute `PATH` resolution recommended |
