...
| [DRIFT-007](issues/DRIFT-007.md) | Medium | Investigating | Session-delete confirmation remains armed invisibly after resize | `drift.c:HandleDeleteSession` | — | — | Confirmed; recommend repaint/recenter after resize and fail closed if the prompt cannot be shown; awaiting user disposition |
