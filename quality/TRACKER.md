...
| [DRIFT-004](issues/DRIFT-004.md) | Medium | Investigating | Settings JSON scanner can edit the wrong object | `drift.c:FindArraySpan`, `drift.c:SaveMembersTo` | — | — | Confirmed; user decision needed on path-aware structural locator |
