...
| [DRIFT-006](issues/DRIFT-006.md) | Medium | Investigating | Relative `additionalDirectories` resolve against the wrong location | `drift.c:LoadMembersFrom`, `drift.c:FindMember` | — | — | Confirmed; recommend anchor-aware identity while preserving relative JSON; awaiting user disposition |
