...
| [DRIFT-035](issues/DRIFT-035.md) | Low | Untriaged | Quick-add from armed edit mode leaves the manifest describing another workspace | `drift.c:HandleQuickAdd`, `drift.c:JumpToMemberAt` | — | — | Found reviewing DRIFT-006; pre-existing global clobbering, no data-integrity impact |
