...
| [DRIFT-002](issues/DRIFT-002.md) | High | Awaiting review | Vim lookup can execute a planted `vim.exe` | `drift.c:1242`, `drift.c:3192` | Codex | — | Fixed with shared absolute-`PATH` resolution; independent review required |
