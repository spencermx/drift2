...
echo === 1/9  source lint: WriteToBuffer row guards ===
...
echo === 2/9  regression tests under AddressSanitizer ===
...
echo === 3/9  path-aware settings JSON regression tests ===
...
echo === 4/9  anchor-aware workspace membership path regression tests ===
...
echo === 5/9  concurrent workspace membership regression tests ===
...
echo === 6/9  fail-closed name metadata regression tests ===
...
echo === 7/9  secure Claude launcher regression tests ===
...
echo === 8/9  secure Vim resolver regression tests ===
...
echo === 9/9  compile drift.c with full warnings ===
